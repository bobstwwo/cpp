    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                string path_to_test = "input/" + args[1];
                string path_to_answer = "output/" + args[2];
        ...
        public static void exportResult(MyBitmap lastBitmap, DateTime m, string path)
        {
            ...
            Console.WriteLine("\nРезультат сохранен в папке: " + path);
            Console.WriteLine("Время работы программы: " + (DateTime.Now - m).Seconds + " секунд");
        }
    }
